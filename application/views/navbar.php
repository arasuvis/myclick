               ...
               <div class="vinay">
                    <ul class="nav nav-tabs">
					   ...
					   <!-- <li ><a  href="#">SIGN IN</a></li> -->
                        ...
                        <li class="<?php if(isset($tab)) if($tab == "property") echo "active";?>"><a  href="<?php if(get_my_status($will_id,2) == 1) { echo base_url('user/property');  } else{ echo "#"; } ?>"><span><?php $status = get_my_status($will_id,3); if($status == 1) { ?><img style="display:inline-block;" src="<?php echo base_url();?>images/tick-36x36.png" id="tick-img"><?php } else { ?><img style="display:inline-block;" src="<?php echo base_url();?>images/tick-36x36.png" class="Vhiden" id="tick-img"><?php } ?></span>PROPERTY DETAILS</a></li>
