...
<article class="col-md-8">
        ...
        <div id="personl-info" class="tab-pane fade in active">
                ...
                <form action="<?php echo base_url('user/family') ?>" method="POST">
                    ...
                    <form>
                        ...
                        <div class="row">
                            ...
                            <?php foreach($gen as $gender) { ?>
                                <div class="button">
                                    <input type="radio" name="a" value="<?php echo $per->gender; ?>" id="<?php echo $gender->id_value ?>"  />
                                    <label for="<?php echo $gender->id_value ?>"><img style= " <?php if(isset($per->gender)) if($per->gender == $gender->gender_type) {echo "filter: grayscale(0%)"; } ?>" src ='<?php echo base_url("images/$gender->id_value.png");?>'></label>
